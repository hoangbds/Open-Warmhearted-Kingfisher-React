        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="pricing14-text195 thq-heading-2">
                    Pricing plan
                  </h2>
                </Fragment>
              )}
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <p>
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text180 thq-body-large">
                          or $200 yearly
                        </p>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  ...
                  <h3>
                    {props.plan2Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text179 thq-heading-3">
                          $29/mo
                        </h3>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  ...
                  <p>
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text189 thq-body-large">
                          or $499 yearly
                        </p>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price16">
                <div className="pricing14-price17">
                  ...
                  <span>
                    {props.plan1Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text177 thq-body-large">
                          or $20 monthly
                        </span>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  ...
                  <h3>
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text201 thq-heading-3">
                          $299/yr
                        </h3>
                      </Fragment>
                    )}
